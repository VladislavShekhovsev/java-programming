...
public class ArraysAsList {
    public static void main(String[] args) {
        ...
        // new method its shortcut of each loop(starting from java1.8) 1.8 its jdk 8
        ...
        drinksWithCaffeine.forEach(drink ->{
            ...
            System.out.println(drinksWithCaffeine.indexOf(drink));
        });
        List<Integer>num2 = Arrays.asList(2,4,5);
        num2.forEach(n-> System.out.println(n*n));
        num2.forEach(n->{
            if(n>2){
